...
! function(e) {
	...
	return function e(t, n, r) {
		...
		1: [function(e, t, n) {
			! function(e, r) {
				"object" == typeof n && void 0 !== t ? r(n) : r((e = e || self).acorn = {})
			}(this, (function(e) {
				"use strict";
				var t = {
				...
				U.isLet = function(e) {
					...
					return this.next(), this.labels.push(B), e.body = this.parseStatement("do"), this.labels.pop(), this.expect(T._while), e.test = this.parseParenExpression(), this.options.ecmaVersion >= 6 ? this.eat(T.semi) : this.semicolon(), this.finishNode(e, "DoWhileStatement")
					...
					if (this.labels.push(B), this.enterScope(0), this.expect(T.parenL), this.type === T.semi) return t > -1 && this.unexpected(t), this.parseFor(e, null);
					var n = this.isLet();
					...
					return this.next(), this.parseFunction(e, H | (n ? 0 : X), !1, t)
					...
					var t;
					this.next(), e.discriminant = this.parseParenExpression(), e.cases = [], this.expect(T.braceL), this.labels.push(W), this.enterScope(0);
				...
				U.parseTryStatement = function(e) {
					...
					return this.next(), e.test = this.parseParenExpression(), this.labels.push(B), e.body = this.parseStatement("while"), this.labels.pop(), this.finishNode(e, "WhileStatement")
				...
				U.parseFunction = function(e, t, n, r) {
					...
					if (this.eat(T._default)) {
						...
						if (this.checkExport(t, "default", this.lastTokStart), this.type === T._function || (n = this.isAsyncFunction())) {
							var r = this.startNode();
							this.next(), n && this.next(), e.declaration = this.parseFunction(r, 4 | H, !1, n)
					...
					return this.next(), this.type === T.string ? (e.specifiers = j, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === T.string ? this.parseExprAtom() : this.unexpected()), this.semicolon(), this.finishNode(e, "ImportDeclaration")
				...
				Y.checkPropClash = function(e, t, n) {
					...
					var r = !1,
						i = -1,
						s = -1;
					t ? (i = t.parenthesizedAssign, s = t.trailingComma, t.parenthesizedAssign = t.trailingComma = -1) : (t = new G, r = !0);
					var a = this.start,
						o = this.startLoc;
					...
					var e = this.startNode();
					if (this.next(), this.type === T.parenL) return this.parseDynamicImport(e);
					this.unexpected()
				...
				Y.parseNew = function() {
					...
					return e.callee = this.parseSubscripts(this.parseExprAtom(), r, i, !0), s && "ImportExpression" === e.callee.type && this.raise(r, "Cannot use new with import()"), this.eat(T.parenL) ? e.arguments = this.parseExprList(T.parenR, this.options.ecmaVersion >= 8, !1) : e.arguments = Z, this.finishNode(e, "NewExpression")
					...
					return this.enterScope(16 | M(n, !1)), this.initFunction(e), this.options.ecmaVersion >= 8 && (e.async = !!n), this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, e.params = this.toAssignableList(t, !0), this.parseFunctionBody(e, !0, !1), this.yieldPos = r, this.awaitPos = i, this.awaitIdentPos = s, this.finishNode(e, "ArrowFunctionExpression")
				...
				ae.initialContext = function() {
					...
					return t === se.f_expr || t === se.f_stat || (e !== T.colon || t !== se.b_stat && t !== se.b_expr ? e === T._return || e === T.name && this.exprAllowed ? v.test(this.input.slice(this.lastTokEnd, this.start)) : e === T._else || e === T.semi || e === T.eof || e === T.parenR || e === T.arrow || (e === T.braceL ? t === se.b_stat : e !== T._var && e !== T._const && e !== T.name && !this.exprAllowed) : !t.isExpr)
					...
					if (1 !== this.context.length) {
						...
						e === se.b_stat && "function" === this.curContext().token && (e = this.context.pop()), this.exprAllowed = !e.isExpr
					...
					!e.beforeExpr || e === T.semi || e === T._else || e === T._return && v.test(this.input.slice(this.lastTokEnd, this.start)) || (e === T.colon || e === T.braceL) && this.curContext() === se.b_stat ? this.context.push(se.f_stat) : this.context.push(se.f_expr), this.exprAllowed = !1
				...
				xe.prototype.reset = function(e, t, n) {
					...
					for (var t = e.pos, n = 0; - 1 !== (n = e.current()) && !be(n);) e.advance();
					return e.pos !== t
					...
					return !1
				}, ge.regexp_validateUnicodePropertyNameAndValue = function(e, t, n) {
					...
					var t = 0;
					for (e.lastStringValue = ""; ve(t = e.current());) e.lastStringValue += ye(t), e.advance();
					...
					if (e.eat(92)) {
						...
						if (e.switchU) {
							var n = e.current();
							(99 === n || we(n)) && e.raise("Invalid class escape"), e.raise("Invalid escape")
						}
						e.pos = t
					}
					var r = e.current();
					...
					var t = e.pos,
						n = 0;
					for (e.lastIntValue = 0; Ae(n = e.current());) e.lastIntValue = 10 * e.lastIntValue + (n - 48), e.advance();
					return e.pos !== t
				}, ge.regexp_eatHexDigits = function(e) {
					var t = e.pos,
						n = 0;
					for (e.lastIntValue = 0; _e(n = e.current());) e.lastIntValue = 16 * e.lastIntValue + Ee(n), e.advance();
					return e.pos !== t
					...
					var t = e.current();
					return we(t) ? (e.lastIntValue = t - 48, e.advance(), !0) : (e.lastIntValue = 0, !1)
				...
				Ie.tryReadTemplateToken = function() {
					...
					if (this.inTemplateElement && this.options.ecmaVersion >= 9) throw Ce;
					this.raise(e, t)
					...
					for (var e = "", t = !0, n = this.pos, r = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
						...
						if (d(i, r)) this.pos += i <= 65535 ? 1 : 2;
							...
							(t ? p : d)(a, r) || this.invalidStringToken(s, "Invalid Unicode escape"), e += De(a), n = this.pos
						}
						t = !1
					}
				...
				}, e.Node = te, e.Parser = O, e.Position = L, e.SourceLocation = R, e.TokContext = ie, e.Token = ke, e.TokenType = m, e.defaultOptions = N, e.getLineInfo = F, e.isIdentifierChar = d, e.isIdentifierStart = p, e.isNewLine = A, e.keywordTypes = y, e.lineBreak = v, e.lineBreakG = S, e.nonASCIIwhitespace = _, e.parse = function(e, t) {
					return O.parse(e, t)
				}, e.parseExpressionAt = function(e, t, n) {
					return O.parseExpressionAt(e, t, n)
				}, e.tokContexts = se, e.tokTypes = T, e.tokenizer = function(e, t) {
					return O.tokenizer(e, t)
				}, e.version = $e, Object.defineProperty(e, "__esModule", {
					value: !0
				})
			}))
		}, {}],
						...
						if ("function" == typeof e[d]) return function() {
							switch (d) {
								...
								case "readPixels":
									...
									g = a;
									const d = [arguments[0], arguments[1], arguments[2], arguments[3], S(arguments[4]), S(arguments[5]), a];
									return l.push(`${y}${n}.readPixels(${d.join(", ")});`), u && E(arguments[2], arguments[3]), c && c(a, d), e.readPixels.apply(e, arguments);
								case "drawBuffers":
							...
							switch (typeof t) {
								...
								case "boolean":
									if (o && -1 === m.indexOf(a(t))) {
										l.push(`${y}const ${n}Variable${m.length} = ${I(d,arguments)};`), m.push(t = a(t));
										break
									}
								default:
									null === t ? l.push(`${I(d,arguments)};`) : l.push(`${y}const ${n}Variable${m.length} = ${I(d,arguments)};`), m.push(t)
							}
							return t
						};
						return f[e[d]] = d, e[d]
				...
				const n = new Proxy(e, {
						get: function(t, n) {
							if ("function" == typeof t[n]) return function() {
								if ("drawBuffersWEBGL" === n) return h.push(`${p}${i}.drawBuffersWEBGL([${s(arguments[0],{contextName:i,contextVariables:o,getEntity:m,addVariable:g,variables:c,onUnrecognizedArgumentLookup:d})}]);`), e.drawBuffersWEBGL(arguments[0]);
								...
								switch (typeof t) {
									...
									case "number":
									case "boolean":
										l && -1 === o.indexOf(a(t)) ? (h.push(`${p}const ${i}Variable${o.length} = ${f(n,arguments)};`), o.push(t = a(t))) : (h.push(`${p}const ${i}Variable${o.length} = ${f(n,arguments)};`), o.push(t));
										break;
									default:
										null === t ? h.push(`${f(n,arguments)};`) : h.push(`${p}const ${i}Variable${o.length} = ${f(n,arguments)};`), o.push(t)
								}
								return t
							};
							return r[e[n]] = n, e[n]
		...
		4: [function(e, t, n) {
			...
			t.exports = {
				gpuMock: function(e, t = {}) {
					...
					function r() {
						return r.output.z ? o.apply(r, arguments) : r.output.y ? r.graphical ? a.apply(r, arguments) : s.apply(r, arguments) : i.apply(r, arguments)
					}
					return r._fn = e, r.constants = t.constants || null, r.context = t.context || null, r.canvas = t.canvas || null, r.graphical = t.graphical || !1, r._imageData = null, r._colorData = null, r.output = n, r.thread = {
						x: 0,
						y: 0,
						z: 0
					}, u(r)
			...
			t.exports = {
				CPUFunctionNode: class extends r {
					...
					astIdentifierExpression(e, t) {
						...
						else this.constants && this.constants.hasOwnProperty(e.name) ? t.push("constants_" + e.name) : t.push("user_" + e.name);
						return t
					}
					astForStatement(e, t) {
			...
			t.exports = {
				CPUKernel: class extends r {
					...
					_mediaTo2DArray(e) {
						...
						let s;
						e.constructor === ImageData ? s = e.data : (i.drawImage(e, 0, 0, n, r), s = i.getImageData(0, 0, n, r).data);
						const a = new Array(r);
						let o = 0;
						for (let e = r - 1; e >= 0; e--) {
					...
					_graphicalKernelBody(e) {
						if (2 === this.output.length) return this._graphicalKernel2DLoop(e) + this._graphicalOutput();
						throw new Error("unsupported size kernel")
					}
					_graphicalOutput() {
			...
			t.exports = {
				FunctionNode: class {
						...
						switch (e.type) {
							...
							case "Identifier":
								...
								if (this.isAstVariable(e)) {
									if ("value" === this.getVariableSignature(e)) return this.getCheckVariableType(e)
								}
					...
					getVariableSignature(e, t) {
						...
						const r = n.join("");
						if (t) return r;
						return ["value", "value[]", "value[][]", "value[][][]", "value[][][][]", "value.value", "value.thread.value", "this.thread.value", "this.output.value", "this.constants.value", "this.constants.value[]", "this.constants.value[][]", "this.constants.value[][][]", "this.constants.value[][][][]", "fn()[]", "fn()[][]", "fn()[][][]", "[][]"].indexOf(r) > -1 ? r : null
					}
					build() {
					...
					astUnaryExpression(e, t) {
						return this.checkAndUpconvertBitwiseUnary(e, t) || (e.prefix ? (t.push(e.operator), this.astGeneric(e.argument, t)) : (this.astGeneric(e.argument, t), t.push(e.operator))), t
					}
			...
			t.exports = {
				FunctionTracer: class {
					...
					getIdentifiers(e) {
						...
						return this.pushState(s), e(), this.trackedIdentifiers = null, this.popState(s), t
					}
					getDeclaration(e) {
						const {
							currentContext: t,
							...
							if (Array.isArray(e))
								...
								case "ForStatement": {
									...
									const n = this.newContext((() => {
										this.pushState(o), this.scan(e.init), this.popState(o), t = this.getIdentifiers((() => {
											this.scan(e.test)
								...
								case "WhileStatement":
									...
									break;
								case "Identifier":
									this.isState(s) && this.trackedIdentifiers.push(e.name), this.identifiers.push({
								...
								case "ReturnStatement":
									...
									break;
								case "MemberExpression":
									this.pushState(a), this.scan(e.object), this.scan(e.property), this.popState(a);
									break;
								case "ExpressionStatement":
		...
		12: [function(e, t, n) {
			...
			t.exports = {
				glKernelString: function(e, t, n, l, h) {
							...
							onReadPixels: e => {
								if (N.subKernels) {
									if (m) {
										...
										p.push(`    result${isNaN(t)?"."+t:`[${t}]`} = ${a(e,N)};`)
									} else p.push(`    const result = { result: ${a(e,N)} };`), m = !0;
									f === N.subKernels.length && p.push("    return result;")
								} else e ? p.push(`    return ${a(e,N)};`) : p.push("    return null;")
							},
							onUnrecognizedArgumentLookup: e => {
								const t = u(e, N.kernelArguments, [], d, c);
								if (t) return t;
								const n = u(e, N.kernelConstants, S ? Object.keys(S).map((e => S[e])) : [], d, c);
								return n || null
							}
						});
					let m = !1,
					...
					let V = [];
					if (d.setIndent(2), N.build.apply(N, t), V.push(d.toString()), d.reset(), N.kernelArguments.forEach(((e, n) => {
							switch (e.type) {
								case "Integer":
								case "Boolean":
								case "Number":
					...
					V.push("    " + (h ? "\n" + h + "    " : "")), V.push(p.join("\n")), V.push("  };"), N.graphical && (V.push(function(e) {
					...
					}(N)), V.push("  innerKernel.getPixels = getPixels;")), V.push("  return innerKernel;");
					let M = [];
					return R.forEach((e => {
				...
				GLKernel: class extends r {
					...
					static combineKernels(e, t) {
						...
						if (3 === t.output.length) {
							return i.splitArray(a, t.output[0] * t.output[1]).map((function(e) {
					...
					checkOutput() {
						...
						for (let e = 0; e < this.output.length; e++)
							if (isNaN(this.output[e]) || this.output[e] < 1) {
                                throw new Error(`${this.constructor.name}.output[${e}] incorrectly defined as \`${this.output[e]}\`, needs to be numeric, and greater than 0`)
                            }
					}
					prependString(e) {
				...
				WebGLFunctionNode: class extends i {
					...
					astFunction(e, t) {
						if (this.isRootKernel) t.push("void");
							...
							if (!this.returnType) {
								this.findLastReturn() && (this.returnType = this.getType(e.body), "LiteralInteger" === this.returnType && (this.returnType = "Number"))
							}
							const {
								returnType: n
							} = this;
						...
						switch (i) {
							...
							case "Integer & Number":
								...
								if (this.pushState("building-integer"), this.astGeneric(e.left, t), t.push(a[e.operator] || e.operator), this.pushState("casting-to-integer"), "Literal" === e.right.type) {
									...
									if ("Integer" !== this.getType(e.right)) throw this.astErrorOutput("Unhandled binary expression with literal", e);
									t.push(n.join(""))
						...
						if (this.onFunctionCall && this.onFunctionCall(this.name, n, e.arguments), t.push(n), t.push("("), i)
							for (let n = 0; n < e.arguments.length; ++n) {
								const r = e.arguments[n],
									i = this.getType(r);
								if (n > 0 && t.push(", "), "Integer" === i) this.castValueToFloat(r, t);
			...
			t.exports = {
				WebGLKernel: class extends r {
					...
					getMainResultSubKernelPackedPixels() {
						...
						for (let t = 0; t < this.subKernels.length; t++) {
							"Integer" === this.subKernels[t].returnType ? e.push(`  gl_FragData[${t+1}] = ${this.useLegacyEncoder?"legacyEncode32":"encode32"}(float(subKernelResult_${this.subKernels[t].name}))`) : e.push(`  gl_FragData[${t+1}] = ${this.useLegacyEncoder?"legacyEncode32":"encode32"}(subKernelResult_${this.subKernels[t].name})`)
						}
					...
					getMainResultSubKernelMemoryOptimizedFloats(e, t) {
						...
						for (let n = 0; n < this.subKernels.length; n++) {
							"Integer" === this.subKernels[n].returnType ? e.push(`  gl_FragData[${n+1}].${t} = float(subKernelResult_${this.subKernels[n].name})`) : e.push(`  gl_FragData[${n+1}].${t} = subKernelResult_${this.subKernels[n].name}`)
						}
					}
					getMainResultKernelNumberTexture() {
					...
					getMainResultSubKernelArray4Texture() {
						...
						switch (this.returnType) {
							...
							case "Integer":
								for (let t = 0; t < this.subKernels.length; ++t) {
									"Integer" === this.subKernels[t].returnType ? e.push(`  gl_FragData[${t+1}] = float(subKernelResult_${this.subKernels[t].name})`) : e.push(`  gl_FragData[${t+1}] = subKernelResult_${this.subKernels[t].name}`)
								}
								break;
							case "Array(2)":
								for (let t = 0; t < this.subKernels.length; ++t) e.push(`  gl_FragData[${t+1}][0] = subKernelResult_${this.subKernels[t].name}[0]`, `  gl_FragData[${t+1}][1] = subKernelResult_${this.subKernels[t].name}[1]`);
		...
		75: [function(e, t, n) {
			const {
				WebGLKernelValueArray2: r
			} = e("../../web-gl/kernel-value/array2");
			t.exports = {
				WebGL2KernelValueArray2: class extends r {}
			}
		}, {
		...
		76: [function(e, t, n) {
			const {
				WebGLKernelValueArray3: r
			} = e("../../web-gl/kernel-value/array3");
			t.exports = {
				WebGL2KernelValueArray3: class extends r {}
			}
		}, {
		...
		77: [function(e, t, n) {
			const {
				WebGLKernelValueArray4: r
			} = e("../../web-gl/kernel-value/array4");
			t.exports = {
				WebGL2KernelValueArray4: class extends r {}
			}
		}, {
		...
		105: [function(e, t, n) {
			...
			t.exports = {
				WebGL2Kernel: class extends r {
					static get isSupported() {
						return null !== h || (this.setupFeatureChecks(), h = this.isContextMatch(p)), h
					}
					static setupFeatureChecks() {
					...
					getMainResultSubKernelPackedPixels() {
						...
						if (!this.subKernels) return "";
						for (let t = 0; t < this.subKernels.length; t++) {
							"Integer" === this.subKernels[t].returnType ? e.push(`  data${t+1} = ${this.useLegacyEncoder?"legacyEncode32":"encode32"}(float(subKernelResult_${this.subKernels[t].name}))`) : e.push(`  data${t+1} = ${this.useLegacyEncoder?"legacyEncode32":"encode32"}(subKernelResult_${this.subKernels[t].name})`)
						}
						return a.linesToString(e)
					}
					getMainResultKernelMemoryOptimizedFloats(e, t) {
			...
			t.exports = {
				GPU: class {
					...
					createKernel(e, t) {
						...
						const l = Object.assign({
								...
								onRequestSwitchKernel: function t(r, i, a) {
									...
									return f.build.apply(f, i), p.replaceKernel(f), n.push(f), f
								}
							}, o),
					...
					combineKernels() {
						...
						for (let e = 0; e < r; e++) arguments[e].setCanvas(t).setContext(n).setPipeline(!0);
						return function() {
			...
			const r = e("acorn"),
				...
				l = {
					...
					getVariableType(e, t) {
						...
						if ("nodeName" in e) switch (e.nodeName) {
							case "IMG":
							case "CANVAS":
								return "HTMLImage";
							case "VIDEO":
							...
							if ("undefined" != typeof OffscreenCanvas && e instanceof OffscreenCanvas) return "OffscreenCanvas";
							if ("undefined" != typeof ImageBitmap && e instanceof ImageBitmap) return "ImageBitmap";
							if ("undefined" != typeof ImageData && e instanceof ImageData) return "ImageData"
						}
						return "Unknown"
					},
					...
					flattenFunctionToString: (e, t) => {
						...
						const c = function e(t) {
							...
							switch (t.type) {
								...
								case "VariableDeclarator":
									if (t.init.object && "ThisExpression" === t.init.object.type) {
										return i(t.init.property.name, !0) ? `${t.id.name} = ${e(t.init)}` : null
									}
						...
						if (u.length > 0) {
							...
							for (let n = 0; n < u.length; n++) {
								const r = u[n];
								a[r] || (a[r] = !0), r && e.push(l.flattenFunctionToString(r, t) + "\n")
							}
							return e.join("") + c
						}
						return c
